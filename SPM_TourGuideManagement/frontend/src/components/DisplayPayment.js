...
// Removed: import styleDisplayPayments from "../style_sheets/Payment.module.css";
...
const DisplayPayment = (props) => {
  ...
  return (
    <div className={styleDisplayPayments.maincontainer}>
      ...
      {data ? (
        <div
          className={styleDisplayPayments.container}
          style={{ width: "1400px" }}>
          <div className={styleDisplayPayments.innercontainer}>
            <h2 className={`text-center ${styleDisplayPayments.headertext}`}>
              Payment Details
            </h2>
            <hr
              className={styleDisplayPayments.divider}
            ...
            <h5 style={{ marginLeft: "90px", marginBottom: "20px" }}>
              Billing Address
            </h5>
            <hr
              className={styleDisplayPayments.divider}
            ...
            <div className={styleDisplayPayments.btncontainer}>
              <Link to={`/update/payment+details/${props.userId}`}>
                <button
                  type="button"
                  className={styleDisplayPayments.btn_update}>
                  Update
                </button>
              </Link>
              <button
                onClick={deleteEntry}
                className={styleDisplayPayments.btn_delete}>
                Delete
              </button>
            </div>
          </div>
        ...
        <div
          className={`text-center ${styleDisplayPayments.nocard}`}
          style={{ width: "1000px" }}>
          <img
            src={illustration}
            alt="Logo"
            className={styleDisplayPayments.illustration}
          />
          <h4 className="text-center" style={{ marginBottom: "30px" }}>
            <strong>You don't have any card details added to the system</strong>
          </h4>
          <Link
            to={"/add/payment+details"}
            className={styleDisplayPayments.btn_update}
            style={{ marginTop: "20px", padding: "6px 40px 6px 40px" }}>
            Add
          </Link>
        </div>
      )}
