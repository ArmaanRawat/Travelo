...
// Removed: import stylesAddPayments from "../style_sheets/Payment.module.css";
      ...
      <div className={stylesAddPayments.container}>
        <div className={stylesAddPayments.innercontainer}>
          <div className="horizontal-center">
            <h2
              className={`text-center margin-bottom ${stylesAddPayments.headertext}`}>
              Add a new card
            </h2>
            <hr
              className={stylesAddPayments.divider}
            ...
            <form
              ...
              <div className="row" style={{ marginTop: "15px" }}>
                <div className="form-group col-md-6">
                  <label
                    for="inputName"
                    className={stylesAddPayments.label}
              ...
              <div
                ...
                <button
                  type="submit"
                  style={{ width: "120px" }}
                  className={stylesAddPayments.btn_update}
                  onClick={createData}>
                  Add
                </button>
              </div>
