...
// Removed: import stylesUpdatePayments from "../style_sheets/Payment.module.css";
      ...
      <div className={stylesUpdatePayments.container}>
        <div className={stylesUpdatePayments.innercontainer}>
          <div className="horizontal-center">
            <h2
              className={`text-center margin-bottom ${stylesUpdatePayments.headertext}`}>
              Update Details
            </h2>
            <hr
              className={stylesUpdatePayments.divider}
            ...
            <form
              ...
              <div className="row" style={{ marginTop: "15px" }}>
                <div className="form-group col-md-6">
                  <label
                    for="inputName"
                    className={stylesUpdatePayments.label}
              ...
              <div
                ...
                <button
                  type="submit"
                  style={{ width: "120px" }}
                  className={stylesUpdatePayments.btn_update}
                  onClick={updateData}>
                  Update
                </button>
              </div>
