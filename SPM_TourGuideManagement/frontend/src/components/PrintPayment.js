...
// Removed: import styles from "../style_sheets/Payment.module.css";
  ...
  return (
    <div className={styles.maincontainer}>
      ...
      <div className={styles.container}>
        <div
          id="printablediv"
          className={`text-center ${styles.tableContainer}`}
          style={{ marginTop: "40px" }}>
          <table className={`${styles.table}`}>
            <thead className={styles.tableHead}>
              <tr>
                <th className={styles.tableContent} scope="col">
                  Order ID
                </th>
                <th className={styles.tableContent} scope="col">
                  Service Name
        ...
        <div style={{ display: "flex" }}>
          {data.length !== 0 ? (
            <p
              ...
              style={{ marginTop: "40px", marginBottom: "20px", flex: "1" }}>
          ...
          <div style={{ height: "fit-content", margin: "auto" }}>
            <Link className={styles.printBtn} onClick={Print}>
              <img
                src={print}
                alt="print icon"
