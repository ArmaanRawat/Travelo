...
export default function BookingHotel() {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://localhost:8070/room/insert", newRoom)
      .then(() => {
        alert("room added");
      })
      .catch((err) => {
  ...
  return (
    <div class="body">
      <section className={styles.home2}></section>
            ...
            <form className={styles.form1} onSubmit={sendData}>
              <div className={`row ${styles.input}`}>
                <div className="col-lg-3 mb-1">
                  <label class="form-label" className={styles.label}>
                    Check In Date
                  </label>
                  <input
                    type="date"
                ...
                <div className={`col-lg-1 ${styles.btn1}`}>
                  <Link
                    ...
                    style={{ weight: "50px", background: "#87C1FF" }}
                    type="submit"
                    to={`/checkout`}>
                    Submit
                  </Link>
