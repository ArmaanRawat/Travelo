  ...
  return (
    <>
      <div className={`container`}>
        <img src={coverImg} alt="Cover Beach" className={`img`} />
        <div className={`layer`}>
          <div className={`centered`}>
            <div className={`headerTxt`}>TRAVEL TO EXPLORE</div>
      ...
      <div
        ...
        <div className={`col`}>
          <div className={`card h-100 ${`cardContainer`}`}>
            <div className={`imgBg`}>
              <img
                src={priceImg}
            ...
            <div
              ...
              <h5 className={`card-title ${`cardHeader`}`}>Get Best Prices</h5>
              <p className={`card-text ${`cardDes`}`}>
        ...
        <div className={`col`}>
          <div className={`card h-100 ${`cardContainer`}`}>
            ...
            <div
              ...
              <h5 className={`card-title ${`cardHeader`}`}>Covid Safe</h5>
              <p className={`card-text ${`cardDes`}`}>
                We have all the curated hotels that have all the precaution for
        ...
        <div className={`col`}>
          <div className={`card h-100 ${`cardContainer`}`}>
            ...
            <div
              className={`card-body`}
              style={{ marginLeft: "10px", marginRight: "20px" }}>
              <h5 className={`card-title ${`cardHeader`}`}>Flexible Payment</h5>
              <p className={`card-text ${`cardDes`}`}>
        ...
        <div className="row text-center">
          ...
          <div className={`col-md-4 mb-0`} style={{ padding: "10px" }}>
            <div className={`reviewCard`}>
              ...
              <h6 className="text-primary mb-3">Traveller</h6>
              <p className="px-xl-3">
                <i className="fas fa-quote-left pe-2"></i>At vero eos et
      ...
      <div style={{ padding: "100px 100px 20px 100px" }}>
        <p className={`text-center ${`destinationHeading`}`}>
