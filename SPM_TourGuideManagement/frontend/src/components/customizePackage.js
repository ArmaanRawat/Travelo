...
function CusPackage() {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://localhost:8070/cusPack/add", newPackage)
      .then(() => {
    ...
    <div className="container" class="p-4 mb-1 bg-white">
      <div class="row">
        <form onSubmit={sendData}>
          <a
            class={myStyle.btnHomeFront}
            href="/find/cusPack"
            style={{ position: "absolute", right: 80, top: 86 }}>
            My packages
          </a>
          <img
            src={pic2}
          ...
          <div class="form-group col-md-6">
            ...
            <input
              ...
              class="form-control"
              id="Date"
              placeholder="Enter arriaval date"
              onChange={(e) => {
          ...
          &nbsp;&nbsp;
          <a href="/search/destination" class={myStyle.btnBack}>
            <strong>Back</strong>
          </a>
          &nbsp;&nbsp;
        </form>
