...
// Removed: import stylesProfile from "../style_sheets/UserProfile.module.css";
    ...
    <>
      {props.userId ? (
        <div className={stylesProfile.maincontainer}>
          ...
          <div
            className={`text-center ${stylesProfile.nocard}`}
            style={{ width: "1000px", padding: "70px 0px 70px 0px" }}>
            <img
              src={underCons}
              alt="Logo"
              className={stylesProfile.illustration}
            />
            <h4
              className="text-center"
              style={{ marginBottom: "30px", marginTop: "20px" }}>
              <strong>Sorry! :( We are still working on this</strong>
            </h4>
          </div>
        </div>
      ) : (
        <>
          ...
          <div style={{ display: "flex", minHeight: "calc(100vh - 80px)" }}>
            <div
              className={`text-center ${stylesProfile.nocard}`}
              style={{ width: "800px", position: "relative", margin: "auto" }}>
              <img
                src={illustration}
                alt="Logo"
                className={stylesProfile.illustration}
              ...
              <Link
                to={"/user/login"}
                className={stylesProfile.btn_update}
